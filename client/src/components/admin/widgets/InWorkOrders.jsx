...
const CurrentOrdersStats = () => {
    ...
    // fetching the orders with flag inWork
    useEffect(() => {
        const getOrdersFromDb = async () => {
            try{

                const fetchedOrders = token && await protectedRequest(token).get('/orders/getordersinwork');
  ...
  return (
    <CardLink to="/admin/orders/inwork">
        <Card>
            <CardTitle>В роботі</CardTitle>
