    ...
    useEffect(() => {
        const getOrdersFromDb = async () => {
            try{
                ...
                const fetchedCurrentOrders = token && await protectedRequest(token).get('/orders/getcurrent');
                const fetchedLastMonthOrders = token && await protectedRequest(token).get('/orders/getlastmonth');
